...
function architect_file_get_html() {
    $dom = new architect_simple_html_dom;
    $args = func_get_args();
...
function architect_str_get_html($str, $lowercase=true) {
    $dom = new architect_simple_html_dom;
...
function architect_file_get_dom() {
    $dom = new architect_simple_html_dom;
    $args = func_get_args();
    $dom->load(call_user_func_array('file_get_contents', $args), true);
    return $dom;
...
function architect_str_get_dom($str, $lowercase=true) {
    $dom = new architect_simple_html_dom;
    $dom->load($str, $lowercase);
    return $dom;
}
...
// -----------------------------------------------------------------------------
class architect_simple_html_dom_node {
    ...
    function architect_simple_html_dom_node($dom){
...
// -----------------------------------------------------------------------------
class architect_simple_html_dom {
    var $root = null;
    var $nodes = array();
    var $callback = null;
    var $lowercase = false;
    ...
    function architect_simple_html_dom($str=null)
    {
    ...
    function prepare($str, $lowercase=true) {
        ...
        $this->root = new architect_simple_html_dom_node($this);
        $this->root->tag = 'root';
    ...
    function parse() {
        ...
        // text
        $node = new architect_simple_html_dom_node($this);
        ++$this->cursor;
