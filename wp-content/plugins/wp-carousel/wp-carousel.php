<?php
	...
	*/
	...
	$wp_carousel_path[2] = preg_replace('/wp-carousel.php', '', $wp_carousel_path[1]);
	$wp_carousel_path[3] = WP_PLUGIN_URL.'/'.$wp_carousel_path[1];
	$wp_carousel_path[4] = WP_CONTENT_URL.'/';
	$wp_carousel_path[5] = WP_PLUGIN_URL.'/';
	$wp_carousel_path[6] = preg_replace('wp-carousel.php', '', $wp_carousel_path[3]);
	$wp_carousel_path[7] = preg_replace('/wp-carousel.php', '', $wp_carousel_path[1]);
	$wp_carousel_path[8] = preg_replace('/', '', preg_replace(get_bloginfo('wpurl'), '', $wp_carousel_path[4]));
