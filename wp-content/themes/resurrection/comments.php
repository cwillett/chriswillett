...
<h3 id="comments">
  ...
  <?php _e('so far')?>, <a href="#respond"><?php _e('say something?')?></a>
</h3>
...
<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
  ...
  <p>
<input name="submit" type="image" src="<?php bloginfo('stylesheet_directory'); ?>/images/icon-done.gif" 
id="submit" tabindex="5" value="<?php _e('Submit')?>" />
