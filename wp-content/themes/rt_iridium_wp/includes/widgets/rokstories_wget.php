...
class RokStoriesWidget extends WP_Widget {
    ...
    function widget($args, $instance){
		...
		<div id="rokstories-<?php echo $id; ?>" class="rokstories-<?php echo $rokstories_layout; ?>">
			<div class="feature-block">
				...
				<?php if($rokstories_layout != 'layout3' || $rokstories_layout != 'layout4') { ?>
					</div>
				<?php } ?>
				
				<div class="desc-container">
					
					<?php if ($contentOptions && ($rokstories_layout == 'layout3' || $rokstories_layout == 'layout4')): ?>
				...
				<?php if($rokstories_layout == 'layout4') { ?>
    ...
    function form($instance){
  		...
  		$instance = wp_parse_args( (array) $instance, array('title'=>'', 'rokstories_layout'=>'layout4', 'rokstories_display'=>'content', 'rokstories_cat'=>'1', 'rokstories_artcount'=>'6', 'rokstories_order'=>'date', 'rokstories_contentpos'=>'none', 'rokstories_title'=>'true', 'rokstories_date'=>'false', 'rokstories_content'=>'false', 'rokstories_readmore'=>'true', 'rokstories_thumbbox'=>'auto', 'rokstories_firstart'=>'0', 'rokstories_thumbopa'=>'1', 'rokstories_interact'=>'click', 'rokstories_autoplay'=>'0', 'rokstories_autoplaydelay'=>'5000', 'rokstories_labeltitle'=>'false', 'rokstories_preview'=>'0', 'rokstories_fixedpreview'=>'1', 'rokstories_linklabel'=>'false', 'rokstories_linkimage'=>'0', 'rokstories_arrows'=>'false', 'rokstories_imgw'=>'620', 'rokstories_imgh'=>'246', 'rokstories_thumbw'=>'90', 'rokstories_thumbh'=>'41' ) );
    	...
    	<select id="<?php echo $this->get_field_id('rokstories_layout'); ?>" name="<?php echo $this->get_field_name('rokstories_layout'); ?>">
      		...
      		<option value="layout4"<?php selected( $instance['rokstories_layout'], 'layout4' ); ?>><?php _re('Compact Showcase with Numbers'); ?></option>
        </select>
        <br /><br />
