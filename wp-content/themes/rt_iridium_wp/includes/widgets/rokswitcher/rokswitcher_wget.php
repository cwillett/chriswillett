...
class RokSwitcherWidget extends WP_Widget {
    ...
    function widget($args, $instance){
 		...
 		$rokswitcher_gui_width = empty($instance['rokswitcher_gui_width']) ? '280' : $instance['rokswitcher_gui_width'];
 		$rokswitcher_gui_styling = empty($instance['rokswitcher_gui_styling']) ? '' : $instance['rokswitcher_gui_styling'];
 		...
 		$rokswitcher_reset = empty($instance['rokswitcher_reset']) ? 'false' : $instance['rokswitcher_reset'];
		...
		<div class="variation-chooser-surround">																			
			<div class="variation-chooser-width" style="width: <?php echo $rokswitcher_gui_width; ?>px; <?php echo $rokswitcher_gui_styling; ?>">
				<img src="<?php bloginfo('template_directory'); ?>/includes/widgets/rokswitcher/images/blank.png" name="variation_preview" class="variation-img" id="variation_preview" border="0" width="<?php echo $rokswitcher_gui_width; ?>" height="208" alt="<?php _re('Style Preview'); ?>" />
				...
				<form action="<?php bloginfo('wpurl'); ?>/?" name="chooserform" method="get" class="variation-chooser">
					...
					<div class="controls">
						...
						<span class="text-prev"><?php _re('Prev Style'); ?></span>
						<span class="text-next"><?php _re('Next Style'); ?></span>
    ...
    function form($instance){
  		...
  		$instance = wp_parse_args( (array) $instance, array('title'=>'Preset Styles', 'rokswitcher_interface'=>'gui', 'rokswitcher_gui_width'=>'280', 'rokswitcher_gui_styling'=>'', 'rokswitcher_text_styling'=>'text-align: center; font-weight: bold;', 'rokswitcher_reset'=>'false', 'rokswitcher_label'=>'Reset Settings', 'rokswitcher_label_styling'=>'text-align: center; margin-bottom: 0;') );
