...
if (is_admin() && $_GET['page'] == $tname.'-settings') {
	...
	wp_enqueue_script('moorainbow', get_bloginfo('template_directory').'/moorainbow/mooRainbow.js');
}
...
function theme_settings_admin_css() {
	...
	<link rel="stylesheet" type="text/css" media="screen" href="'.get_bloginfo('template_directory').'/moorainbow/mooRainbow.css" />
	<!--[if lte IE 6]>
