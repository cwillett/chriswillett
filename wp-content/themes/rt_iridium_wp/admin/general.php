	...
	<div class="general-wrapper">
		...
		<div class="tabbar">
			...
			<div class="tab3 singletab">
				<div class="tabl"></div>
				<div class="tabr"><a href="#showcase"><?php _re('Showcase'); ?></a></div>
			</div>
		...
		<div class="inner-tabber">	
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="breadcrumbs"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[breadcrumbs]" id="breadcrumbs" <?php if($option['breadcrumbs'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="ie_warning"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[ie_warning]" id="ie_warning" <?php if($option['ie_warning'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="site_logo"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[site_logo]" id="site_logo" <?php if($option['site_logo'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="search_box"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[search_box]" id="search_box" <?php if($option['search_box'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_copyright"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[footer_copyright]" id="footer_copyright" <?php if($option['footer_copyright'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_backtop"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[footer_backtop]" id="footer_backtop" <?php if($option['footer_backtop'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_logo"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[footer_logo]" id="footer_logo" <?php if($option['footer_logo'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="footer_copyright_text">
									<input class="textbox" id="footer_copyright_text" type="text" size="15" maxlength="255" name="iridium-options[footer_copyright_text]" value="<?php echo $option['footer_copyright_text']; ?>" />
                   				</label>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="text_sizer"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[text_sizer]" id="text_sizer" <?php if($option['text_sizer'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
								<?php if(!rok_isIE()) { ?><label class="text_sizer" for="text_sizer"></label><?php } ?>
								<a href="#" rel="rokbox[350 50][module=op-text_sizer]"><span class="help">Help</span></a>
							</div>
							<div id="op-text_sizer" class="rthide"><?php _re('Displays text size options in the header.'); ?></div>
						</div>
					</td>
					<td class="secondcol">
					</td>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="blog_order">
									<select id="blog_order" name="iridium-options[blog_order]">
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="blog_content">
									<select id="blog_content" name="iridium-options[blog_content]">
				...
				<tr>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="blog_cat">
									<input class="textbox" id="blog_cat" type="text" size="15" maxlength="255" name="iridium-options[blog_cat]" value="<?php echo $option['blog_cat']; ?>" />
                   				</label>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="blog_title"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[blog_title]" id="blog_title" <?php if($option['blog_title'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="blog_title_link"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[blog_title_link]" id="blog_title_link" <?php if($option['blog_title_link'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="blog_meta"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[blog_meta]" id="blog_meta" <?php if($option['blog_meta'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="blog_author"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[blog_author]" id="blog_author" <?php if($option['blog_author'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="blog_date"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[blog_date]" id="blog_date" <?php if($option['blog_date'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
			...
			<span class="section-title"><?php _re('Showcase'); ?></span><br /><br />
			...
			<table class="options_table">
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							<div class="paramtext">
								<?php _re('Showcase Blogroll:'); ?>
							</div>
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="showcase_blogroll"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[showcase_blogroll]" id="showcase_blogroll" <?php if($option['showcase_blogroll'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
								<?php if(!rok_isIE()) { ?><label class="showcase_blogroll" for="showcase_blogroll"></label><?php } ?>
								<a href="#" rel="rokbox[350 50][module=op-showcase_blogroll]"><span class="help">Help</span></a>
							</div>
							<div id="op-showcase_blogroll" class="rthide"><?php _re('Displays the blogroll in the showcase area.'); ?></div>
						</div>
					</td>
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="showcase_blogroll_order">
									<select id="showcase_blogroll_order" name="iridium-options[showcase_blogroll_order]">
      			   						<option value="ID" <?php if ($option['showcase_blogroll_order'] == "ID") : ?>selected="selected"<?php endif; ?>>ID</option>    	
      			   						<option value="url" <?php if ($option['showcase_blogroll_order'] == "url") : ?>selected="selected"<?php endif; ?>><?php _re('URL'); ?></option> 
      			   						<option value="name" <?php if ($option['showcase_blogroll_order'] == "name") : ?>selected="selected"<?php endif; ?>><?php _re('Name'); ?></option> 
      			   						<option value="target" <?php if ($option['showcase_blogroll_order'] == "target") : ?>selected="selected"<?php endif; ?>><?php _re('Target'); ?></option>
      			   						<option value="rating" <?php if ($option['showcase_blogroll_order'] == "rating") : ?>selected="selected"<?php endif; ?>><?php _re('Rating'); ?></option>
      			   						<option value="updated" <?php if ($option['showcase_blogroll_order'] == "updated") : ?>selected="selected"<?php endif; ?>><?php _re('Updated'); ?></option>
      			   						<option value="rss" <?php if ($option['showcase_blogroll_order'] == "rss") : ?>selected="selected"<?php endif; ?>><?php _re('RSS'); ?></option>
      			   						<option value="lenght" <?php if ($option['showcase_blogroll_order'] == "lenght") : ?>selected="selected"<?php endif; ?>><?php _re('Lenght'); ?></option>
      			   						<option value="rand" <?php if ($option['showcase_blogroll_order'] == "rand") : ?>selected="selected"<?php endif; ?>><?php _re('Random'); ?></option>	    				
      			     				</select>
      			     			</label>
      			     			<a href="#" rel="rokbox[350 70][module=op-showcase_blogroll_order]"><span class="help">Help</span></a>
							</div>
							<div id="op-showcase_blogroll_order" class="rthide"><?php _re('Changes blogroll order in the showcase area.'); ?></div>
						</div>
					</td>
				</tr>
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="showcase_blogroll_limit">
									<input class="textbox" id="showcase_blogroll_limit" type="text" size="3" maxlength="255" name="iridium-options[showcase_blogroll_limit]" value="<?php echo $option['showcase_blogroll_limit']; ?>" />
                   				</label>
                   				<a href="#" rel="rokbox[350 50][module=op-showcase_blogroll_limit]"><span class="help">Help</span></a>
							</div>
							<div id="op-showcase_blogroll_limit" class="rthide">Here you can limit the number of displayed links in blogroll, -1 displays all links.</div>
						</div>
					</td>
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="showcase_blogroll_category">
									<input class="textbox" id="showcase_blogroll_category" type="text" size="3" maxlength="255" name="iridium-options[showcase_blogroll_category]" value="<?php echo $option['showcase_blogroll_category']; ?>" />
                   				</label>
                   				<a href="#" rel="rokbox[350 50][module=op-showcase_blogroll_category]"><span class="help">Help</span></a>
							</div>
							<div id="op-showcase_blogroll_category" class="rthide">Comma separated list of numeric Category IDs to be displayed. If none is specified, all Categories with bookmarks are shown.</div>
						</div>
					</td>
				</tr>
			</table>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_enabled"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[footer_enabled]" id="footer_enabled" <?php if($option['footer_enabled'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="footer_order">
									<select id="footer_order" name="iridium-options[footer_order]">
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="footer_cat">
									<?php wp_dropdown_categories('show_option_none=None&hide_empty=0&name=iridium-options[footer_cat]&exclude=1&orderby=name&selected='.$option['footer_cat']); ?>
      			     			</label>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="footer_post_count">
									<input class="textbox" id="footer_post_count" type="text" size="3" maxlength="255" name="iridium-options[footer_post_count]" value="<?php echo $option['footer_post_count']; ?>" />
                   				</label>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_popular_enabled"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[footer_popular_enabled]" id="footer_popular_enabled" <?php if($option['footer_popular_enabled'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
					...
					<td class="secondcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_recent_enabled"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[footer_recent_enabled]" id="footer_recent_enabled" <?php if($option['footer_recent_enabled'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="footer_modified_enabled"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[footer_modified_enabled]" id="footer_modified_enabled" <?php if($option['footer_modified_enabled'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="footer_content">
									<select id="footer_content" name="iridium-options[footer_content]">
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="site_width">
									<input class="textbox" id="site_width" type="text" size="3" maxlength="255" name="iridium-options[site_width]" value="<?php echo $option['site_width']; ?>" />px
                   				</label>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="left_sidebar_w">
									<input class="textbox" id="left_sidebar_w" type="text" size="3" maxlength="255" name="iridium-options[left_sidebar_w]" value="<?php echo $option['left_sidebar_w']; ?>" />px
                   				</label>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="right_sidebar_w">
									<input class="textbox" id="right_sidebar_w" type="text" size="3" maxlength="255" name="iridium-options[right_sidebar_w]" value="<?php echo $option['right_sidebar_w']; ?>" />px
                   				</label>
				...
				<tr>
					<td class="firstcol">
						<div class="paramfield">
							...
							<div class="paramcheck onlycheck">
								<?php if(rok_isIE()) { ?><label class="rokbox_enabled"><?php } ?><input type="checkbox" value="true" class="checkbox" name="iridium-options[rokbox_enabled]" id="rokbox_enabled" <?php if($option['rokbox_enabled'] == 'true') { ?>checked="checked"<?php } ?> /><?php if(rok_isIE()) { ?></label><?php } ?>
						...
						<div class="paramfield">
							...
							<div class="paramcheck">
								<label class="rokbox_style">
									<select id="rokbox_style" name="iridium-options[rokbox_style]">
