	...
	<?php if (have_comments()) : ?>
 	...
 	<?php else : // this is displayed if there are no comments so far ?>
		...
		<div class="attention"><div class="icon"><?php _re('Comments are closed.'); ?></div></div>
	...
	<div id="respond">
		...
		<div class="attention"><div class="icon"><?php _re('You must be'); ?> <a href="<?php echo wp_login_url( get_permalink() ); ?>"><?php _re('logged in'); ?></a> <?php _re('to post a comment.'); ?></div></div>
